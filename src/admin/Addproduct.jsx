...
const Addproduct = () => {
  ...
  const [ndata,setndata] = useState({
    types:'',category:'',subcategory:'',product_name:'',size:{},product_price:'',product_sprice:'',product_stock:'',image:{},discription:'',feature:''
  });
...
const postdata = async(e) =>{
  ...
  setLoading(true)
 try {
await axios.post(`${url}/addproducts`,{ndata})
.then((response) => {
 if(response.status === 201){
  toast.success('Data added successfully', {
    ...
    setndata({ types:'',category:'',subcategory:'',product_name:'',size:'',product_price:'',product_sprice:'',product_stock:'',image:{},discription:'',feature:''})    
    setTimeout(() => {
      setLoading(false)
  ...
  return (
    <>
      <div>
           ...
           <ToastContainer/>
           <div className={loading ? 'w-[80vw] h-[80vh] bg-[#ffffff86] z-10 absolute':null}>
           ...
           <HashLoader
                ...
                <div className='flex flex-col mr-8 ml-5'>
                  ...
                  <div className='flex flex-col mr-8 ml-5 w-[54vw] my-5'>
                  <label htmlFor="product" className='text-md font-[600]'>Enter Stocks Size</label>
                  <div className='flex h-7 gap-4 my-3'>
                 {
                    size.map( e =>
                    <>
                       <label htmlFor={e.name} className='font-bold'>{e.name}</label>
                       <input name={e.name} type="number" className='text-center w-[5vw]' onChange={handelSize}/>
                 ...
                 <label htmlFor="Total" className='font-bold ml-9'>Total Stocks</label>
                 <input type="number" className='text-center w-[10vw]' name='product_stock' onChange={handel} disabled value={ndata.product_stock} />
                 </div>
                  </div>
                  <div className='flex flex-col mr-8 ml-5'>
                  ...
                  <div className='flex flex-col my-3 mr-4 ml-5'>
                  ...
                  <div className='flex flex-col mr-4 ml-5 w-[25%]'>
                  ...
                  <div className='mr-4 w-[20%] h-[90px] feature_p py-2 px-1' >
                 ...
                 <div className='flex justify-end pl-12 mb-6'>
                  ...
                  <div className='flex text-center items-center justify-center w-full my-10 mx-8'>
                    <button className='text-lg font-[600] bg-blue-500 w-[50vw] h-10 text-center text-white rounded-md' onClick={postdata}>Upload</button>
                  </div>
                </div>
            </div>
      </div>
